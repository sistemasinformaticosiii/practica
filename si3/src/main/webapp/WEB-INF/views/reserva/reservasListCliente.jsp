...
<tiles:insertDefinition name="defaultTemplategeneral">
	<tiles:putAttribute name="body">
		<b>Lista de reservas | Practica si3</b>
		<br />
		<br />
		<table border="1">
			<tr>
			...
			<c:forEach var="reserva" items="${listaResultados}">
				<tr>
					...
					<td><a
						href="/si3/deletereserva?id=${reserva.key.reservationId}">Borrar</a></td>

				</tr>
			</c:forEach>
			<tr>
				<td colspan="8"><a href="registerreserva">Añadir reserva</a></td>
			</tr>
		</table>
