 ...
 <script>
   ...
   <div class="left_content">
    <div class="title_box"><spring:message code="left.tiposdeofertas"/></div>
        ...
        <li class="odd"><a href="<c:url value="javascript:enviar_formulario_entradas()"/>"><spring:message code="left.tipoofertas.entradas"/></a></li>
        ...
        <li class="even"><a href="<c:url value="javascript:enviar_formulario_restaurantes()"/>"><spring:message code="left.tipoofertas.restaurantes"/></a></li>
        ...
        <li class="odd"><a href="<c:url value="javascript:enviar_formulario_actividades()"/>"><spring:message code="left.tipoofertas.actividades"/></a></li>
        </ul> 
